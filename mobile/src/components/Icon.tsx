...
import {
  AlertCircle, Anchor, Apple, ArrowLeft, ArrowRight, Banknote, Bed, Bell,
  ...
  GraduationCap, Heart, Image as ImageIcon, Info, Lightbulb, Lock, LogOut,
  Map, MapPin, MessageCircle, Minus, Navigation, PenLine, Plane, Plus,
  PlusCircle, Receipt, Search, Send, Share2, ShieldCheck, ShoppingBag,
  ShoppingCart, SlidersHorizontal, Sparkles, Star, Sun, ThumbsUp,
  Trash2, TrendingDown, User, UserMinus, UserPlus, Users, Wrench, X,
  XCircle,
...
function isFilled(name: string): boolean {
  ...
  // Only apply fill to glyphs where the visual distinction matters.
  return name === 'star' || name === 'heart' || name === 'bookmark' || name === 'checkmark-circle';
}
