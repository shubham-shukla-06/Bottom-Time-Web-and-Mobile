...
async def seed_database() -> None:
    ...
    if rich_count == 0:
        ...
        samples = [
            ("Maldives Reef Divers", "day_dive", "Premier dive center in the heart of Maldives with access to world-class reef diving. Explore vibrant coral gardens, encounter manta rays, and drift dive through crystal-clear channels.", "Male", "Maldives", 150.0, "intermediate", "https://images.unsplash.com/photo-1654359631058-4edc4446e829?w=800&q=80&auto=format", 4.8, 234, ["PADI certified", "Equipment included", "Small groups", "Manta ray encounters"]),
            ("Advanced Wreck Diving Course", "course", "Learn wreck diving techniques and safety procedures with hands-on training at real wreck sites along the Indian coastline.", "Goa", "India", 299.0, "advanced", "/api/static/listings/advanced-wreck-diving-course.png", 4.9, 87, ["Certification included", "Expert instructor", "Real wreck sites"]),
            ("Caribbean Liveaboard Adventure", "liveaboard", "7-day liveaboard journey exploring the best Caribbean dive sites. Multiple dives daily with experienced crew and all meals included.", "Grand Cayman", "Cayman Islands", 1899.0, "intermediate", "/api/static/listings/caribbean-liveaboard-adventure.png", 4.7, 156, ["All meals included", "Multiple dives daily", "Experienced crew"]),
            ("Sarah Thompson - PADI Master Instructor", "course", "20+ years experience teaching all levels from beginner to professional. Specializing in patient, confidence-building instruction in warm tropical waters.", "Bali", "Indonesia", 80.0, "beginner", "/api/static/listings/sarah-thompson-padi-master-instructor.png", 5.0, 312, ["PADI Master Instructor", "Multilingual", "Patient teaching style"]),
            ("Blue Horizon Dive Center", "trip", "Family-run dive center on the stunning coast of Hurghada. Access to famous Red Sea reefs, wall dives, and night diving experiences.", "Hurghada", "Egypt", 65.0, "beginner", "https://images.unsplash.com/photo-1551244072-5d12893278ab?w=800&q=80&auto=format", 4.6, 189, ["Red Sea access", "Night dives available", "Family friendly"]),
            ("Open Water Diver Certification", "course", "Start your diving journey with a full PADI Open Water Diver course. Includes pool sessions, theory, and open water dives in crystal-clear Thai waters.", "Koh Tao", "Thailand", 350.0, "beginner", "https://images.unsplash.com/photo-1576842052285-eb317349a0a6?w=800&q=80&auto=format", 4.9, 421, ["PADI certification", "All equipment provided", "Small class sizes"]),
            ("Raja Ampat Explorer Liveaboard", "liveaboard", "10-day expedition through the heart of the Coral Triangle. Raja Ampat boasts the highest marine biodiversity on Earth.", "Sorong", "Indonesia", 3200.0, "advanced", "https://images.unsplash.com/photo-1502209524164-acea936639a2?w=800&q=80&auto=format", 4.9, 78, ["Coral Triangle", "30+ dive sites", "Marine biologist on board"]),
            ("Marco Rivera - Underwater Photography Pro", "day_dive", "Award-winning underwater photographer offering dive + photography workshops. Learn to capture the ocean's beauty.", "Cozumel", "Mexico", 120.0, "intermediate", "https://images.unsplash.com/photo-1635177731608-cdc20aa0fa7d?w=800&q=80&auto=format", 4.8, 145, ["Photography workshop", "Camera rental included", "Award-winning instructor"]),
            ("Great Barrier Reef Day Trips", "trip", "Daily departures to the outer Great Barrier Reef. Snorkel or dive among the world's most famous coral ecosystem.", "Cairns", "Australia", 210.0, "beginner", "https://images.unsplash.com/photo-1437622368342-7a3d73a34c8f?w=800&q=80&auto=format", 4.7, 567, ["Great Barrier Reef", "Lunch included", "Snorkel + dive combo"]),
        ]
        docs = []
    ...
    if product_count == 0:
        now = datetime.now(timezone.utc).isoformat()
        sample_products = [
            {"id": str(uuid.uuid4()), "name": "Bottom Time Logo Tee", "category": "merch", "description": "Soft cotton crew neck with embroidered wave logo. Unisex fit.", "price": 34.99, "currency": "USD", "image_url": "/api/static/products/bottom-time-logo-tee.png", "sizes": ["S","M","L","XL"], "in_stock": True, "sold_count": 245, "weight": 0.2, "status": "active", "created_at": now, "rating": 4.8, "review_count": 52},
            {"id": str(uuid.uuid4()), "name": "Dive Flag Cap", "category": "merch", "description": "Embroidered dive flag on structured snapback. One size fits all.", "price": 28.99, "currency": "USD", "image_url": "/api/static/products/dive-flag-cap.png", "sizes": ["One Size"], "in_stock": True, "sold_count": 189, "weight": 0.1, "status": "active", "created_at": now, "rating": 4.6, "review_count": 33},
            {"id": str(uuid.uuid4()), "name": "Ocean Explorer Hoodie", "category": "merch", "description": "Heavyweight French terry hoodie. Perfect for post-dive warmth.", "price": 64.99, "currency": "USD", "image_url": "/api/static/products/ocean-explorer-hoodie.png", "sizes": ["S","M","L","XL","XXL"], "in_stock": True, "sold_count": 167, "weight": 0.6, "status": "active", "created_at": now, "rating": 4.9, "review_count": 41},
            {"id": str(uuid.uuid4()), "name": "Reef Sticker Pack", "category": "merch", "description": "Set of 8 waterproof vinyl stickers. Marine life and dive motifs.", "price": 12.99, "currency": "USD", "image_url": "/api/static/products/reef-sticker-pack.png", "sizes": [], "in_stock": True, "sold_count": 412, "weight": 0.05, "status": "active", "created_at": now, "rating": 4.5, "review_count": 78},
            {"id": str(uuid.uuid4()), "name": "Dry Bag 20L", "category": "gear", "description": "Waterproof roll-top dry bag. Keep your gear safe on the boat.", "price": 39.99, "currency": "USD", "image_url": "/api/static/products/dry-bag-20l.png", "sizes": [], "in_stock": True, "sold_count": 334, "weight": 0.35, "status": "active", "created_at": now, "rating": 4.7, "review_count": 61},
            {"id": str(uuid.uuid4()), "name": "Dive Computer Wrist Mount", "category": "gear", "description": "Universal wrist strap for dive computers. Quick-release buckle.", "price": 24.99, "currency": "USD", "image_url": "/api/static/products/dive-computer-wrist-mount.png", "sizes": [], "in_stock": True, "sold_count": 156, "weight": 0.08, "status": "active", "created_at": now, "rating": 4.4, "review_count": 29},
            {"id": str(uuid.uuid4()), "name": "Reef-Safe Sunscreen SPF50", "category": "essentials", "description": "Biodegradable, coral-safe mineral sunscreen. 100ml travel size.", "price": 18.99, "currency": "USD", "image_url": "/api/static/products/reef-safe-sunscreen-spf50.png", "sizes": [], "in_stock": True, "sold_count": 523, "weight": 0.15, "status": "active", "created_at": now, "rating": 4.8, "review_count": 94},
            {"id": str(uuid.uuid4()), "name": "Mesh Gear Bag", "category": "gear", "description": "Large mesh bag for rinsing and drying dive equipment. 80L capacity.", "price": 29.99, "currency": "USD", "image_url": "/api/static/products/mesh-gear-bag.png", "sizes": [], "in_stock": True, "sold_count": 201, "weight": 0.45, "status": "active", "created_at": now, "rating": 4.3, "review_count": 37},
            {"id": str(uuid.uuid4()), "name": "Underwater Torch 1000 Lumens", "category": "gear", "description": "Rechargeable dive torch with 3 modes. Rated to 100m depth.", "price": 54.99, "currency": "USD", "image_url": "/api/static/products/underwater-torch-1000-lumens.png", "sizes": [], "in_stock": True, "sold_count": 98, "weight": 0.3, "status": "active", "created_at": now, "rating": 4.6, "review_count": 22},
            {"id": str(uuid.uuid4()), "name": "Bottom Time Water Bottle", "category": "merch", "description": "Insulated stainless steel bottle. 750ml. Keeps cold for 24hrs.", "price": 29.99, "currency": "USD", "image_url": "/api/static/products/bottom-time-water-bottle.png", "sizes": [], "in_stock": True, "sold_count": 298, "weight": 0.4, "status": "active", "created_at": now, "rating": 4.7, "review_count": 56},
            {"id": str(uuid.uuid4()), "name": "Neoprene Mask Strap Cover", "category": "gear", "description": "Comfortable padded neoprene strap for any dive mask. Prevents hair pulling.", "price": 14.99, "currency": "USD", "image_url": "/api/static/products/neoprene-mask-strap-cover.png", "sizes": [], "in_stock": True, "sold_count": 445, "weight": 0.05, "status": "active", "created_at": now, "rating": 4.9, "review_count": 102},
            {"id": str(uuid.uuid4()), "name": "Silicone Defog Spray", "category": "essentials", "description": "Anti-fog spray for dive masks. 60ml bottle lasts 100+ dives.", "price": 9.99, "currency": "USD", "image_url": "/api/static/products/silicone-defog-spray.png", "sizes": [], "in_stock": True, "sold_count": 678, "weight": 0.08, "status": "active", "created_at": now, "rating": 4.5, "review_count": 134},
            {"id": str(uuid.uuid4()), "name": "Dive Slate & Pencil", "category": "essentials", "description": "Underwater communication slate with attached pencil. Wrist mount.", "price": 16.99, "currency": "USD", "image_url": "/api/static/products/dive-slate-and-pencil.png", "sizes": [], "in_stock": True, "sold_count": 312, "weight": 0.12, "status": "active", "created_at": now, "rating": 4.3, "review_count": 58},
            {"id": str(uuid.uuid4()), "name": "Dive Reel 30m", "category": "gear", "description": "Compact finger spool with 30m line. Essential for SMB deployment.", "price": 32.99, "currency": "USD", "image_url": "/api/static/products/dive-reel-30m.png", "sizes": [], "in_stock": True, "sold_count": 167, "weight": 0.15, "status": "active", "created_at": now, "rating": 4.6, "review_count": 31},
            {"id": str(uuid.uuid4()), "name": "Surface Marker Buoy (SMB)", "category": "gear", "description": "Bright orange delayed SMB with oral inflate and dump valve.", "price": 27.99, "currency": "USD", "image_url": "/api/static/products/surface-marker-buoy-smb.png", "sizes": [], "in_stock": True, "sold_count": 234, "weight": 0.2, "status": "active", "created_at": now, "rating": 4.7, "review_count": 44},
            {"id": str(uuid.uuid4()), "name": "Wetsuit Shampoo 250ml", "category": "essentials", "description": "Extends wetsuit life. Removes salt, chlorine and odors.", "price": 11.99, "currency": "USD", "image_url": "/api/static/products/wetsuit-shampoo-250ml.png", "sizes": [], "in_stock": True, "sold_count": 389, "weight": 0.28, "status": "active", "created_at": now, "rating": 4.4, "review_count": 67},
        ]
