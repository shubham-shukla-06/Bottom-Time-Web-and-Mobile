      ...
      <div className="bg-white rounded-3xl p-8 max-w-md w-full max-h-[90vh] overflow-y-auto">
        {flow.pendingOperator ? (
          ...
          <>
            ...
            {flow.step === 2 && !flow.isSignup && <StepLogin email={flow.email} setEmail={flow.setEmail} loading={flow.loading} onSendOTP={flow.handleSendEmailOTP} onSwitchToSignup={flow.switchToSignup} />}
